...
dics = []
cnt = Counter()
with open("vanillamodel.txt", 'r') as model:
    for line in model:
        dics.append(line)
...
# all_files = glob.glob(os.path.join("op_spam_training_data",'negative_polarity/deceptive_from_MTurk/fold3/d_hyatt_18.txt'))
